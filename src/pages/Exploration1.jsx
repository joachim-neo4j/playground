...
function Toolbar({ tool, onToolChange, onUndo, onRedo, canUndo, canRedo }) {
  ...
  const RectangleIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor" className="h-5 w-5">
      <path d="M590.77-369.23Zm-240 128.77q4.61.23 9 .34 4.38.12 9.46.12 5.92 0 11.04-.12 5.11-.11 10.5-.34v46.61q0 10.77 6.92 17.7 6.93 6.92 17.69 6.92h350.77q10.77 0 17.7-6.92 6.92-6.93 6.92-17.7v-350.77q0-10.76-6.92-17.69-6.93-6.92-17.7-6.92h-46.61q.23-5.39.34-10.5.12-5.12.12-11.04 0-5.08-.12-9.46-.11-4.39-.34-9h46.61q26.66 0 45.64 18.98t18.98 45.63v350.77q0 26.66-18.98 45.64t-45.64 18.98H415.38q-26.65 0-45.63-18.98-18.98-18.98-18.98-45.64v-46.61Zm18.61-110.31q-100.23 0-170.19-69.81-69.96-69.82-69.96-170.04 0-100.23 69.81-170.19 69.82-69.96 170.04-69.96 100.23 0 170.19 69.81 69.96 69.82 69.96 170.04 0 100.23-69.81 170.19-69.82 69.96-170.04 69.96Zm-.15-40q83 0 141.5-58.5t58.5-141.5q0-83-58.5-141.5t-141.5-58.5q-83 0-141.5 58.5t-58.5 141.5q0 83 58.5 141.5t141.5 58.5Zm0-200Z"/>
    </svg>
  );
